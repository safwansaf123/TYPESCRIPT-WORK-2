...
let totalAircrafts: number = 28;
let airports: number = 4;
let divide: number = totalAircrafts/airports;
console.log(divide);// simple divide//

let totalAircrafts: number = 48;
let airports: number = 5
