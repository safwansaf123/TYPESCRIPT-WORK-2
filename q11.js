...
; // this will not print due color not matched//
if (alien_color == "green") {
    console.log(alien_color);
}
; // in continuation of point 2 of q11.ts//
if (alien_color == "green") {
    console.log("you earned 5 points");
}
else {
    console.log("you have earned 10 points more");
}
;
...
alien_color = "blue";
if (alien_color == "green") {
    console.log("you have finish the goal");
} // in this case it will not print//
