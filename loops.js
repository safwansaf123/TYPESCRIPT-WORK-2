...
let i; // because data store in array [] in form of numbers [0,1,2,3,4,5,]
let names = ["safoo", "adil", "asharib", "ameen", "reeha", "marium"];
...
let k;
let names1 = ["safoo", "adil", "asharib", "ameen", "reeha", "marium", "mehwish"];
//example 1
for (k in names1) {
